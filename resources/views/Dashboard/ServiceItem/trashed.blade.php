...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">Trashed Service Item Table</h5>
    ...
    <div class="card-body">
        ...
        <a href="{{route('ServiceItem.index')}}">
                        ...
                        <div class="list-icons">
                            <div class="list-icons-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="{{route('ServiceItem.restore',[$item->id])}}" class="dropdown-item"><i class="icon-rotate-cw2 "></i>Restore </a>


                                    <form action="{{route('ServiceItem.hardDelete',$item->id)}}" method="POST"  >
                                        @csrf
                                        @method('DELETE')
