...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">Trashed Category Table</h5>
                        ...
                        <div class="list-icons">
                            <div class="list-icons-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="{{route('Category.restore',[$item->id])}}" class="dropdown-item"><i class="icon-rotate-cw2 "></i>Restore </a>


                                    <form action="{{route('Category.hardDelete',$item->id)}}" method="POST"  >
                                        @csrf
                                        @method('DELETE')
