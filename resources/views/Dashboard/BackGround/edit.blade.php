...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">Edit Back Ground</h5>
    ...
    <div class="card-body">
        ...
        <Form action="{{route('BackGround.update',$back_ground->id)}}" class="form-validate-jquery" method="post" enctype="multipart/form-data">
        @csrf
        ...
        @endif
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input type="file" name="image" class="form-control" value="{{$back_ground->image}}">
                </div>
            </div>
