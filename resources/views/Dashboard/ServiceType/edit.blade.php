...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">Edit {{$service_type->name_en}}</h5>
    ...
    <div class="card-body">
        ...
        <Form action="{{route('ServiceType.update',$service_type->id)}}" class="form-validate-jquery" method="post" enctype="multipart/form-data">
        @csrf
        ...
        @endif
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input type="text" name="name_en" class="form-control" value="{{$service_type->name_en}}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input type="text" name="name_ar" class="form-control" value="{{$service_type->name_ar}}">
                </div>
            </div>
