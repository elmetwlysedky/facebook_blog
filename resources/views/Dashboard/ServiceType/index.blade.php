...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <a href="{{route('ServiceType.trashed')}}" class="btn btn-link btn-float font-size-sm font-weight-semibold text-default">
                            ...
                            <div class="list-icons">
                                <div class="list-icons-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{route('ServiceType.show',$item->id)}}" class="dropdown-item"><i class="icon-file-eye2 mr-3 icon"></i> show </a>
                                        <a href="{{route('ServiceType.edit',$item->id)}}" class="dropdown-item"><i class="icon-pencil7"></i> Edit </a>

                                        <div class="dropdown-divider"></div>
                                        <form action="{{route('ServiceType.destroy',$item->id)}}" method="POST"  >
                                            @csrf
                                            @method('DELETE')
