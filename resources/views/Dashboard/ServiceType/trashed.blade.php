...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">Trashed Service Type Table</h5>
                        ...
                        <div class="list-icons">
                            <div class="list-icons-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="{{route('ServiceType.restore',[$item->id])}}" class="dropdown-item"><i class="icon-rotate-cw2 "></i>Restore </a>


                                    <form action="{{route('ServiceType.hardDelete',$item->id)}}" method="POST"  >
                                        @csrf
                                        @method('DELETE')
